...
import { stripInvisibleEntityArtifacts, fixUnescapedCaptionQuotes } from '@/utils/text'
...
function parseHero(content: string): { src: string | null; alt: string; caption: string; bodyHtml: string } {
  ...
  const doc = parser.parseFromString(fixUnescapedCaptionQuotes(stripInvisibleEntityArtifacts(content)), 'text/html')
...
function processContent(html: string): string {
  ...
  const pre = new DOMParser().parseFromString(fixUnescapedCaptionQuotes(stripInvisibleEntityArtifacts(html)), 'text/html')
